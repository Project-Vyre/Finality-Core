...
public class ModItems {
    ...
    public static final RegistryObject<Item> TAU_BACKTANK = ITEMS.register("tau_backtank", () -> new TauBacktank(ArmorMaterials.NETHERITE, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).stacksTo(1), new ResourceLocation("textures/enitty/placeholder.png"), ModItems.TAU_BACKTANK_PLACEABLE.lazyMap(item -> {
        // Return Backtank supplier
        return null;
    })));


    public static final RegistryObject<Item> TAU_BACKTANK_PLACEABLE = ITEMS.register("tau_backtank_placeable", () -> new BacktankItem.BacktankBlockItem(ModBlocks.TAU_BACKTANK_BLOCK.get(), ModItems.TAU_BACKTANK, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)));
