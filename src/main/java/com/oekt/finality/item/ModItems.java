...
public class ModItems {
    ...
    public static final RegistryObject<Item> LIVING_NETHER_SPORES = ITEMS.register("living_nether_wart_spores", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS).stacksTo(64)));
